...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.img_is_uploaded'
        db.add_column('bmxacademy_video', 'img_is_uploaded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.img_is_uploaded'
        db.delete_column('bmxacademy_video', 'img_is_uploaded')
