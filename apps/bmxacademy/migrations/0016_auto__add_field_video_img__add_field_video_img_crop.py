...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.img'
        db.add_column('bmxacademy_video', 'img',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.img_crop'
        db.add_column('bmxacademy_video', 'img_crop',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.img'
        db.delete_column('bmxacademy_video', 'img')

        # Deleting field 'Video.img_crop'
        db.delete_column('bmxacademy_video', 'img_crop')
