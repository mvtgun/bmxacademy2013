...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Participant.first_name'
        db.delete_column('bmxacademy_participant', 'first_name')

        # Deleting field 'Participant.last_name'
        db.delete_column('bmxacademy_participant', 'last_name')

        # Adding field 'Participant.name'
        db.add_column('bmxacademy_participant', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Participant.first_name'
        db.add_column('bmxacademy_participant', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Participant.last_name'
        db.add_column('bmxacademy_participant', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'Participant.name'
        db.delete_column('bmxacademy_participant', 'name')
