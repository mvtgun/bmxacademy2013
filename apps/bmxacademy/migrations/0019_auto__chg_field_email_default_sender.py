...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Email.default_sender'
        db.alter_column('bmxacademy_email', 'default_sender', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Email.default_sender'
        db.alter_column('bmxacademy_email', 'default_sender', self.gf('django.db.models.fields.EmailField')(max_length=255))

    models = {
        'bmxacademy.email': {
            'Meta': {'object_name': 'Email'},
            'default_sender': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
