...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.phone'
        db.alter_column('bmxacademy_message', 'phone', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Message.subject'
        db.alter_column('bmxacademy_message', 'subject', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Message.phone'
        db.alter_column('bmxacademy_message', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=16))

        # Changing field 'Message.subject'
        db.alter_column('bmxacademy_message', 'subject', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
